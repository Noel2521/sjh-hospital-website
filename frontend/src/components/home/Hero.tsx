...
export default function Hero() {
  ...
  return (
    ...
    >
        ...
        {heroSlides.map((slide, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, rgba(8,38,34,0.62) 0%, rgba(8,38,34,0.75) 60%, rgba(8,38,34,0.85) 100%)",
              }}
            />
          </div>
        ))}
      ...
      {/* Content */}
      <div className="relative z-[5] text-center px-7 pb-[40px] max-w-[760px] animate-[fadeUp_0.9s_ease_both]">
        <div
        ...
        >
          NABH Certified · Multi-Speciality Hospital · Mysuru
        </div>
      ...
      {/* Dots */}
      <div className="absolute bottom-7 left-1/2 -translate-x-1/2 flex gap-2 z-[6]">
        {heroSlides.map((slide, i) => (
          <button
            key={slide.id}
