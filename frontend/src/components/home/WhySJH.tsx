        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            >
              ...
              />
              <div>
                <strong className="block text-white text-[13.5px] mb-0.5">NABH Entry Level Certified</strong>
                <p className="text-[11.5px] text-white/50 leading-relaxed">
                  Patient Safety &amp; Quality of Care<br />National Accreditation Board for Hospitals
                </p>
              </div>
            </div>
          </div>
